class SystemPlanetBar {
  ...
  for (let key in counts) {
    dataArray.push({sy_pnum: key, count: counts[key]});
  }
  ...
  vis.xScale = d3.scaleBand()
    .domain(dataArray.map(d => d.sy_pnum))
  ...
  vis.yScale = d3.scaleLinear()
    ...
    .text("Exoplanets by # of Planets in their System");
